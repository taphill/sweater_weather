...
RSpec.describe 'Api/V1/Forecast request', type: :request do
  describe 'GET /api/v1/forecast?location=', :vcr do
    ...
    it 'should not have uneeded attributes' do
      expect(json_body[:data][:attributes]).to_not have_key(:lat)
      expect(json_body[:data][:attributes]).to_not have_key(:lon)
      expect(json_body[:data][:attributes]).to_not have_key(:timezone)
      expect(json_body[:data][:attributes]).to_not have_key(:timezone_offset)
      expect(json_body[:data][:attributes]).to_not have_key(:minutely)

      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:dt)
      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:temp)
      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:pressure)
      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:dew_point)
      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:clouds)
      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:wind_deg)
      expect(json_body[:data][:attributes][:current_weather]).to_not have_key(:weather)

      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:dt)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:temp)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:feels_like)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:pressure)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:humidity)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:dew_point)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:wind_speed)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:wind_deg)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:weather)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:clouds)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:pop)
      expect(json_body[:data][:attributes][:daily_weather].first).to_not have_key(:uvi)

      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:dt)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:temp)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:feels_like)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:pressure)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:humidity)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:dew_point)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:wind_deg)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:weather)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:clouds)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:pop)
      expect(json_body[:data][:attributes][:hourly_weather].first).to_not have_key(:uvi)
    end
  end
